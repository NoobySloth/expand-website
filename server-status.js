...
const SERVER_ID = urlParams.get('serverId') || 'rpvd3p'; // Add Your server ID here Just Replace 'y4lg95' with your server ID (y4lg95 is a Fivem b299 server ID example)
...
function updateConnectLink() {
    try {
        ...
        const joinUrl = `fivem://connect/cfx.re/join/rpvd3p`
